...
const accordionData = [
    { title: "Daňové poradenství", content: (<ul className="ul-popis"><li>Analýza daňové situace – Identifikace oblastí pro optimalizaci daní.</li>
    ...
    { title: "Kontrola a optimalizace daňových nákladů", content: (<ul className="ul-popis"><li>Detailní přezkum účetních dokladů – Odhalení možných úspor.</li>
    ...
    { title: "Účetnictví pro firmy", content: <ul className="ul-popis"><li>Komplexní vedení účetnictví – Evidence příjmů, výdajů a majetku.</li>
    ...
    { title: "Konzultace u klienta", content: <ul className="ul-popis"><li>Osobní setkání přímo u vás – Konzultace v prostředí vaší firmy.</li>
...
function Sluzby() {
    ...
    return (
    <div className="sluzby-background">
        <div id="sluzby" className="sluzby-container">
            <div className="sluzby">
                <p className="p-sluzby">SLUŽBY</p>
